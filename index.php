  ...
  <body>
    <div class="wrapper">
      ...
      <nav>
        <ul>
          <li>
            <a class="currentlink" href="index.php">Bio</a>
          </li>
          <li>
        ...
        <main>
          <article>
            <div id="content">
              ...
              <p>My career embodies the synergy between coding proficiency and commercial acumen, consistently delivering solutions where technology meets profitability. Whether constructing conversion-optimized WordPress sites, executing precision arbitrage strategies, or revolutionizing dropshipping operations.  I operate with a singular mission: to create digital advantage through innovation, automation, and relentless focus on client success.</p>
              <p>
